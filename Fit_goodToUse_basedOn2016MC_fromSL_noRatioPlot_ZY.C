...
void fit();
void Fit_goodToUse_basedOn2016MC_fromSL_noRatioPlot_ZY() { fit(); }
void fit() {
...
//    TFile *ntuple_mc = new TFile("12April2023_ntuple_v3_pfIso0p35forZmu_0p7forUpsiMu_2016_2017_2018_Total_Data.root");
  TFile *ntuple_mc = new TFile("MC_DPS_Weighted_Run2_Total_ZY_v3.root"); //this version of the root file, the v3, has upsi_type as a double, which turns out to be 

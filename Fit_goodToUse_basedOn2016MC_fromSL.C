...
void fit() {
 ...
 //Upsi variables
  RooRealVar upsi_pT ("upsi_pT", "upsi_pT", 0, 1200); // this was originally a dummy variable, hence this comment, which I leave because it amuses me
 ...
 //Z variables
  RooRealVar Z_pT("Z_pT","Z_pT",0, 1000);
 ...
 RooRealVar lead_pT_mu_from_Z_pT("lead_pT_mu_from_Z_pT", "lead_pT_mu_from_Z_pT", 20, 900); 
 ...
 RooRealVar sublead_pT_mu_from_Z_pT("sublead_pT_mu_from_Z_pT", "sublead_pT_mu_from_Z_pT",10,300);
 ...
 RooRealVar lead_pT_mu_from_upsi_pT ("lead_pT_mu_from_upsi_pT", "lead_pT_mu_from_upsi_pT", 0, 1200);
...
//    std::cout << "///////////////////////////////////////////" << std::endl; 
 ...
 int lead_pT_mu_from_Z_pT_bins = 10;
 int lead_pT_mu_from_Z_RAP_bins = 5;
 int lead_pT_mu_from_Z_eta_bins = 8;
 int lead_pT_mu_from_Z_phi_bins = 5;
 
 int sublead_pT_mu_from_Z_pT_bins = 10;
